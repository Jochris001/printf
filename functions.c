#include "main.h"
/************************* THIS IS TO PRINT CHAR *************************/
/**
 * print_unsigned - This is to Prints a char
...
/**
 * print_unsigned - This is to Prints a string
 * @types: this is to List an arguments
 * @buffer: this ia to allocate Buffer array to handle print
 * @flags:  the Calculation of active flags
 * @width: to factor out width
...
/************************* THIS IS TO PRINT PERCENT SIGN *************************/
/**
 * print_unsigned - This is to Prints a percent sign
 * @types: this is to List an arguments
 * @buffer: this ia to allocate Buffer array to handle print
 * @flags:  the Calculation of active flags
 * @width: to factor out width
...
/**
 * print_unsigned - This is to Print int
 * @types: this is to List an arguments
 * @buffer: this ia to allocate Buffer array to handle print
 * @flags:  the Calculation of active flags
 * @width: to factor out width
